...
class OutboxDespachadorTest {
    ...
    private static final String PAYLOAD = "{\"servicio\":\"ms-usuarios\",\"accion\":\"CREATE\"}";
     ...
     * convertidor de mensajes. Si se re-serializara, el consumidor recibirÃ­a una
     * cadena escapada y el evento acabarÃ­a en la dead-letter queue.
     */
    @Test
    void publicar_envÃ­aElPayloadTalCualComoJsonPersistente() {
    ...
    /** Con el broker caÃ­do la fila se queda pendiente para el siguiente barrido. */
    @Test
