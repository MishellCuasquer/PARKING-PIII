 ...
 *
 * Corre cada 10 segundos. Mientras RabbitMQ estÃ© caÃ­do los intentos fallan y
 * las filas se quedan donde estÃ¡n; cuando vuelve, el primer barrido las envÃ­a
 * todas en orden. Es lo que hace que una caÃ­da del broker no pierda eventos.
 */
@Component
...
public class OutboxDespachador {
     ...
     *
     * `convertAndSend` con un String aplicarÃ­a el JacksonJsonMessageConverter
     * sobre un texto que YA es JSON, y el consumidor recibirÃ­a una cadena
     * escapada (`"{\"servicio\":...}"`) en vez de un objeto: el DTO no validarÃ­a
     * y el evento acabarÃ­a en la dead-letter queue.
     *
     * @return true si el evento llegÃ³ al broker
     */
    ...
    /**
     * La outbox es un buzÃ³n de trÃ¡nsito, no un histÃ³rico: ese vive en ms-audit.
     * Se limpian a diario las filas ya enviadas de mÃ¡s de un dÃ­a.
     */
