 ...
 *
 * El evento se persiste aquí antes de intentar publicarlo en RabbitMQ. Si el
 * broker está caído la fila queda pendiente y el reintento periódico la envía
...
public class OutboxEvent {
    ...
    /** NULL mientras esté pendiente de publicar. */
